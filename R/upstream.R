upstream <- function(gene_name, genofile, objNull, variant_type=c("SNV","Indel","variant"), genes_info,
  ...
  result = c(list("gene_info" = gene_info_kk, "category" = "upstream"), result.upstream)
